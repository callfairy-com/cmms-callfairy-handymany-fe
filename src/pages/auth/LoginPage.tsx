      ...
      >
        ...
        <Card className="p-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-brutal font-bold text-black mb-2">WELCOME BACK!</h2>
          ...
          <div className="mt-6 text-center">
            ...
            <p className="text-sm text-neu-600">
              ...
              <a href="#" className="font-brutal font-bold text-black hover:text-primary-600 transition-colors">
                CONTACT ADMIN
              </a>
            </p>
          </div>
