...
import { useAuth, decodeJWT } from '../contexts/AuthContext';
      ...
      if (success) {
        ...
        setTimeout(() => {
          addNotification({
            ...
            message: `You have successfully logged in to CRM-Fairy. You have 2 pending work orders and 1 maintenance due today.`,
            actionUrl: '/dashboard'
          });
        }, 500);

        // Redirect based on role: contractors go to work orders, others to dashboard
        // read role from access token as the auth state may not have updated yet
        ...
        // Admin/Manager/Viewer default to /dashboard
        navigate(redirectTo);
      } else {
        ...
        <div className="hidden lg:block">
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">CRM-Fairy</h1>
            ...
            <div className="space-y-4 mt-12">
              ...
              <p className="text-slate-600 text-lg">
                Comprehensive work order management, asset tracking, and compliance monitoring in one powerful platform.
              </p>
        ...
        <div className="w-full">
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
            ...
            <div className="lg:hidden flex items-center justify-center space-x-3 mb-8">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">CRM-Fairy</h1>
          ...
          <p className="text-center text-sm text-slate-600 mt-6">
            © 2024 CRM-Fairy. All rights reserved.
          </p>
        </div>
      </div>
    </div>
