...
export function Layout({ children }: LayoutProps) {
  ...
  // TODO: Update these permission strings to use new RBAC permissions
  // All navigation items with required permissions
  const allNavigation = [
    {
      name: 'Dashboard',
    ...
    },
    {
      ...
      href: '/settings',
      icon: Settings,
      permissions: ['can_configure_system_settings', 'can_manage_organization']
    },
  ];
        ...
        <div className="flex items-center justify-between h-16 px-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-900">CRM-Fairy</h1>
      ...
      >
        ...
        {hasPermission('can_manage_users') && (
          <div className="px-4 pb-4">
            <Link
              to="/user-management"
              className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors ${isActive('/user-management')
                ? 'bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-400'
                : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'
                }`}
            >
        ...
        <div className="p-4 border-t border-slate-200 mt-auto">
          <button
            ...
            className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg text-slate-700 hover:bg-slate-50"
          >
